...
?>
  ...
  <head> <link rel="stylesheet" href="myhome.css"></head>
...
<section id="hero" class="d-flex align-items-center justify-content-center">
  ...
  <h1 style="--i:10"> Resturant for online delivering</h1>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="../image/foodhome.webp" style=" background-color: white!important; border: none!important;" class="img-fluid imagemove" alt="">
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="row g-4">
                <div class="col-md-4 ">
                    <div class="blog-post card-effect  " style="background-color: #ECEFF1;">
                        <img src="../image/fast del-compressed.jpg" alt="">
                ...
                <div class="col-md-4 ">
                    <div class="blog-post card-effect" style="background-color: #ECEFF1;">
                        <img src="../image/foods1-compressed.jpg" alt="">
                ...
                <div class="col-md-4 ">
                    <div class="blog-post card-effect" style="background-color: #ECEFF1;">
                        <img src="../image/team-compressed.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row people d-flex justify-content-center">
                <!-- <div class="col-md-6 col-lg-4 item">
                    <div class="box hiddenn"><img class="rounded-circle" data-bs-hover-animate="pulse" src="../image/noornawzad.jpg">
                        <h3 class="name">Noor Nawzad</h3>
                        <p class="title">Website helper</p>
                        <p class="description"><br>Hello I'm Noor , I'm a web site helper And working with developer to create a website , I'll help the developers in the front end if you want to know more about my work click contact below<br><br></p>
                        <div class="social"><a href="#"><i class="fa-brands fa-facebook-f"></i></a></div>
                    </div>
                </div> -->
                <div class="col-md-6 col-lg-4 item">
                    <div class="box hiddenn"><img class="rounded-circle" data-bs-hover-animate="pulse" src="../image/ayodeveloper-compressed.jpg">
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box hiddenn"><img class="rounded-circle" data-bs-hover-animate="pulse" src="../image/kure khalide-compressed.jpg">
                        <h3 class="name">Mohammed khalid</h3>
                        <p class="title">Website helper</p>
...
<section id="contact ">
 ...
 <form action="home.php" method="POST" class="row g-3 justify-content-center">
 <div class="col-md-5">
